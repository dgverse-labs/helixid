...
import { AgentWallet, checkScope, delegate, requireScope, VPBuilder, verifyVP, } from '../../src/index.js';
describe('standalone SDK exports', () => {
    ...
    it('checks and requires scopes from a verification result', () => {
        ...
        const narrowed = { ...result, effectiveScopes: [] };
...
//# sourceMappingURL=sdk-standalone.test.js.map