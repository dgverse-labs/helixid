...
describe('HelixErrors', () => {
  it('instantiates all error classes', () => {
    const errorClasses = [
      ...
      () => new Errors.DelegationNotPermittedError(),
      () => new Errors.DelegationDepthExceededError(),
      () => new Errors.DelegationScopeEscalationError('write:orders'),
      () => new Errors.DelegationChainInvalidError('missing parent'),
      () => new Errors.DelegationParentVCNotFoundError(),
      () => new Errors.DelegationParentVCRevokedError(),
